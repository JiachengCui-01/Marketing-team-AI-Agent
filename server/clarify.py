...
_SYSTEM = (
    ...
    "The executing agent has a live market-data source: it queries SellerSprite (卖家精灵) "
    "for Amazon category size and demand trend, competitor and ASIN price/BSR/rating/review "
    "counts, keyword search volume, brand and seller concentration, and price bands. Those "
    "are retrievable, not missing: NEVER ask the user for a market figure, a competitor's "
    "numbers, or which products sell best in a category. Asking trades a fetch the agent "
    "does in seconds for a wait on a human who usually cannot answer it anyway. What it "
    "cannot retrieve is our OWN operating data — sales, ad spend, returns — which needs an "
    "uploaded file; ask for that only when the request is specifically about our own "
    "numbers and no data file is attached.\n"
