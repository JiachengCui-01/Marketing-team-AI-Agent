...
const MEMORY_VALUE_LABELS: Record<string, { zh: string; en: string }> = {
  // Keys must match the canonical values emitted by server/memory.py's
  // heuristic pattern tables. Change one, change the other.
  ...
  "Product & sourcing": { zh: "产品 / 选品 / 供应链", en: "Product & sourcing" },
  "Operations & logistics": { zh: "运营 / 物流", en: "Operations & logistics" },
  "Furniture & home furnishings": { zh: "家具 / 家居", en: "Furniture & home furnishings" },
  "Cross-border export / DTC": { zh: "跨境出口 / DTC", en: "Cross-border export / DTC" },
  "Design & contract manufacturing": { zh: "自主设计 / 代工生产", en: "Design & contract manufacturing" },
  ...
  "Large furniture (sofa, bed, table, storage)": {
    zh: "大件家具（沙发 / 床架 / 餐桌 / 储物）",
    en: "Large furniture (sofa, bed, table, storage)",
  },
  "Materials & finishes": { zh: "材质与工艺", en: "Materials & finishes" },
  "Home decor & soft furnishings": { zh: "家居饰品 / 软装", en: "Home decor & soft furnishings" },
  "US homeowners & renters": { zh: "美国房主与租客", en: "US homeowners & renters" },
  "First-time & new-home furnishers": { zh: "首次置业 / 新居入住", en: "First-time & new-home furnishers" },
  "Interior design enthusiasts": { zh: "室内设计爱好者", en: "Interior design enthusiasts" },
  Amazon: { zh: "亚马逊", en: "Amazon" },
  "Wayfair / Overstock": { zh: "Wayfair / Overstock", en: "Wayfair / Overstock" },
  "Own DTC store": { zh: "自有独立站", en: "Own DTC store" },
  "Instagram / Meta": { zh: "Instagram / Meta", en: "Instagram / Meta" },
  Pinterest: { zh: "Pinterest", en: "Pinterest" },
  "TikTok / short video": { zh: "TikTok / 短视频", en: "TikTok / short video" },
  "Email/newsletter": { zh: "邮件 / EDM", en: "Email/newsletter" },
  "Paid search & shopping": { zh: "搜索与购物广告", en: "Paid search & shopping" },
  Professional: { zh: "专业正式", en: "Professional" },
  "Warm and authentic": { zh: "温暖真实", en: "Warm and authentic" },
  "Premium/refined": { zh: "高级精致", en: "Premium/refined" },
  "Playful/young": { zh: "年轻活泼", en: "Playful/young" },
  "Marketplace listing": { zh: "平台 Listing", en: "Marketplace listing" },
  "Product page copy": { zh: "商详页文案", en: "Product page copy" },
  "Marketing copy": { zh: "营销文案", en: "Marketing copy" },
  "Report/brief": { zh: "报告 / 简报", en: "Report/brief" },
  "Campaign plan": { zh: "上架 / 活动方案", en: "Campaign plan" },
  ...
  "Returns and after-sales metrics": { zh: "退货与售后指标", en: "Returns and after-sales metrics" },
  "Margin and landed cost": { zh: "毛利与落地成本", en: "Margin and landed cost" },
  ...
  const labels =
    locale === "zh"
      ? {
          ...
          kbManage: "管理个人知识库",
          memoryGroup: "长期记忆",
          memoryBody: "查看和修改自动总结出的业务画像（品类、渠道、目标客户、口径偏好）。",
          memoryHint: "每行一个偏好或事实，系统会在后续对话中优先参考这些信息。",
          memoryAuto: "聊天中识别到的长期业务信息会自动沉淀到这里，你也可以手动修正。一次性的产品参数不会被记住。",
          memoryEnabled: "自动长期记忆开关",
          memoryEnabledBody: "开启后，系统会在多次对话中逐步沉淀你的业务画像。",
          memorySave: "保存手动记忆",
          memoryClear: "清空手动记忆",
          ...
          reportFormatPreferences: "交付物格式偏好",
          kpiDataPreferences: "KPI / 指标口径偏好",
      ...
      : {
          ...
          memoryBody: "View and edit the business profile summarized from your chats.",
