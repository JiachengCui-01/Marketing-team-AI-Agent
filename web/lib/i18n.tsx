...
const messages = {
  zh: {
    ...
    heroTitle: "你的全能 AI 工作台",
    heroBody: "既能办公——发起审批、派发任务、预约日程、检索知识库；也能做营销——内容创作、活动分析、竞品研究。直接说需求即可。",
    chatHeader: "对话",
  ...
  en: {
    ...
    navSubtitle: "Office · Content · Analytics · Research",
    newChat: "New chat",
    newGroup: "New group",
    ...
    heroTitle: "Your all-in-one AI workspace",
    heroBody: "Handle office work — approvals, tasks, scheduling, knowledge-base lookups — and marketing — content, campaign analysis, competitor research. Just say what you need.",
    chatHeader: "Chat",
